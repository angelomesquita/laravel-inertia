...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("layout", [
    _c("div", [_vm._v("Olá " + _vm._s(_vm.user) + " voce está na home.")]),
    _vm._v(" "),
    _vm.$page.props.flash.success
      ? _c("div", { staticStyle: { border: "1px solid green" } }, [
          _vm._v(
      ...
      [
        _vm._l(_vm.errors, function(error, index) {
          return _c(
            ...
            {
              key: index,
              staticStyle: { border: "1px solid red", "margin-bottom": "10px" }
            },
            [_vm._v("\n            " + _vm._s(error) + "\n        ")]
          )
        }),
        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              attrs: { type: "email", placeholder: "seu email" },
